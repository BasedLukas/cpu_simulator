...
from gates import and_, not_, or_
    ...
    class Cycle:
        ...
        def execute(self):
            if self.control.output[0]:
                ...
                print()
                self.compare = Comparison(self.program_instruction_byte[5:8], self.cpu.registers[3])#control is program 3 lsb, 
                self.update_pc = and_(self.compare.out, self.control.output[3])
